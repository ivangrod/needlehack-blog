...
<img class="no-shadow" alt="Screenshot showing the bew backup overview page which shows you exactly when your last backup took place" src="{{site.baseurl}}/images/blog/2025-01/backups-status.png" />
