...
<img class="no-shadow" alt="Screenshot showing the backup locations, one location indicates that encryption has been turned off." src="{{site.baseurl}}/images/blog/2025-02/backups-encryption-turned-off.png" />
