...
<img class="no-shadow" alt="Screenshot showing the generic setting where you can set the default AI task entity to use" src="{{site.baseurl}}/images/blog/2025-08/ai-suggestions.png" />
